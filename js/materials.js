...
var CAR_DOME_MATERIAL = [new THREE.MeshPhongMaterial({color: 0x00aaff,specular: 0x020202,shininess: 200, transparent:true, opacity:0.6}), new THREE.MeshLambertMaterial( {color: 0x00aaff, transparent:true, opacity:0.6})];
